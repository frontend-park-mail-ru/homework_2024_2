...
QUnit.module('Тестируем функцию euclid', function () {
	...
	QUnit.test('Функция должна выдавать ошибку если введено не целое число', function (assert) {
		...
		assert.throws(function() {euclid(1, 'a', 1) },/Все аргументы должны быть целыми числами/, 'проверка на ввод аргумента отличного от числа в середине');
		assert.throws(function() {euclid('a', 1, 1) },/Все аргументы должны быть целыми числами/, 'проверка на ввод аргумента отличного от числа в начале');
		assert.throws(function() {euclid(1, 1,'a') },/Все аргументы должны быть целыми числами/, 'проверка на ввод аргумента отличного от числа в конце');
	});
});
