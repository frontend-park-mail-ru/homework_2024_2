...
QUnit.module("Тестируем функцию euclid", function () {
    ...
    QUnit.test("ДОБ.: Функция может принимать нечисловые аргументы", function (assert) {
        ...
        assert.throws(
            ...
            TypeError,
            "euclid(null, 2) выбрасывает ошибку"
        );
        ...
        assert.throws(
            ...
            TypeError,
            "euclid(1, true) выбрасывает ошибку"
        );
        ...
        assert.throws(
            ...
            TypeError,
            "euclid(undefined, 2) выбрасывает ошибку"
        );
    });
