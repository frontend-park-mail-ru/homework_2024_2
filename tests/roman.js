...
QUnit.module('Тестируем функцию roman', function () {
	...
	QUnit.test('roman работает при передачe типа данных object', function (assert) {
		assert.strictEqual(roman(new String('MCMIV')), 1904);
		assert.strictEqual(roman(new Number(1904)), 'MCMIV');
	});
});
